...
WorldModelROS::WorldModelROS(tf::TransformListener* tf_listener)
    : loop_rate_(20), world_model_(0), tick_count(0), tf_listener_(tf_listener), is_tf_owner_(false), last_update_duration(0),
...
bool WorldModelROS::initialize() {
    ...
    n.getParam("publish_frequency", pub_frequency_);
